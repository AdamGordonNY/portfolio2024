...
export const buttons = [
  ...
  },
  {
    ...
    component: (
      <button className="text-white hover:bg-white hover:text-black rounded-md border-2 border-transparent bg-teal-500 px-8 py-2 font-bold transition duration-200 hover:border-teal-500">
        Invert it
      </button>
    ),
  },
  {
    ...
    showDot: false,
    component: (
      <button className="text-white group relative inline-block cursor-pointer rounded-full bg-slate-800 p-px text-xs font-semibold leading-6 no-underline  shadow-2xl shadow-zinc-900">
        <span className="absolute inset-0 overflow-hidden rounded-full">
          <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100"></span>
        </span>
        <div className="ring-white/10 relative z-10 flex items-center space-x-2 rounded-full bg-zinc-950 px-4 py-0.5 ring-1 ">
  ...
  },
  {
    ...
    component: (
      <button className="text-white rounded-full bg-gradient-to-b from-blue-500 to-blue-600 px-8 py-2 transition duration-200 hover:shadow-xl focus:ring-2 focus:ring-blue-400">
        Gradient
      </button>
    ),
  },
  {
    ...
    component: (
      <button className="border-black text-black dark:border-white group relative border  bg-transparent px-8 py-2 transition duration-200">
        <div className="absolute -bottom-2 -right-2 -z-10 size-full bg-yellow-300 transition-all duration-200 group-hover:bottom-0 group-hover:right-0" />
  ...
  },
  {
    ...
    component: (
      <button className="bg-white text-black rounded-xl border border-neutral-600 px-4 py-2 transition duration-200 hover:bg-gray-100">
        Outline
      </button>
    ),
  },
  ...
  },
  {
    ...
    component: (
      <button className="bg-white rounded-md px-8 py-2 font-light text-[#696969] shadow-[0_4px_14px_0_rgb(0,0,0,10%)] transition duration-200 ease-linear hover:shadow-[0_6px_20px_rgba(93,93,93,23%)]">
        Next White
      </button>
    ),
  },
  ...
  },
  {
    ...
    showDot: false,
    component: (
      <button className="border-black bg-white/[0.2] text-black rounded-md border px-4 py-2 text-sm backdrop-blur-sm transition duration-200 hover:shadow-[0px_0px_4px_4px_rgba(0,0,0,0.1)]">
        Backdrop blur
      </button>
    ),
  },
  {
    ...
    component: (
      <button className="text-black hover:text-white rounded-full bg-transparent px-12 py-4 font-bold uppercase tracking-widest shadow-[inset_0_0_0_2px_#616467] transition duration-200 hover:bg-[#616467] dark:text-neutral-200">
        Playlist
      </button>
    ),
  },
  {
    ...
    component: (
      <button className="duration-400 bg-black text-white rounded-lg px-6 py-2 font-bold transition hover:-translate-y-1">
        Figma
      </button>
    ),
  },
  {
    ...
    component: (
      <button className="duration-400 border-black text-black dark:border-white dark:text-white rounded-lg border bg-transparent px-6 py-2 font-bold shadow-[0_0_0_3px_#000000_inset] transition hover:-translate-y-1">
        Figma Outline
      </button>
    ),
  },
  {
    ...
    showDot: false,
    component: (
      <button className="text-white hover:shadow-white/[0.1] relative rounded-full border border-slate-600 bg-slate-700 px-8 py-2 text-sm transition duration-200 hover:shadow-2xl">

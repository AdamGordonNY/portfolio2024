  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative ">
      <motion.p
        ...
        className="text-black dark:text-white cursor-pointer hover:opacity-90"
      >
        {item}
      </motion.p>
      {active !== null && (
          ...
          {active === item && (
            <div className="absolute left-1/2 top-[calc(100%_+_1.2rem)] -translate-x-1/2 pt-4">
              <motion.div
                ...
                className="bg-white dark:bg-black border-black/[0.2] dark:border-white/[0.2] overflow-hidden rounded-2xl border shadow-xl backdrop-blur-sm"
              >
                <motion.div

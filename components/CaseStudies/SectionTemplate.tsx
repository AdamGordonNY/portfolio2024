...
const SectionTemplate = ({
  ...
  return (
    <section className="md:paragraph-regular body-regular mq450:w-full flex w-4/5 flex-1 items-center justify-center font-satoshi  text-white-900">
      <div className="custom-responsive-width my-10 flex  items-center justify-between gap-y-5 max-md:px-3 md:px-1">
        {" "}
        <span className="modern-h3 max-mq450:body-regular basis-1/2  align-top font-inter text-white-900">
          {" "}
          {topic}
        </span>
